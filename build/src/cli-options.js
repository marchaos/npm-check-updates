...
const extendedHelpGroup = () => {
  ...
  */`)}
  ${chalk_1.default.cyan('groupFunction')}: (name, defaultGroup, currentSpec, upgradedSpec, upgradedVersion} {
...
const cliOptions = [
    ...
    },
    {
        ...
        arg: 'args',
        description: 'Specifies extra arguments to pass to the install command of a single package install during the doctor mode package upgrade check.',
        type: 'string',
    },
    {
        long: 'doctorTest',

...
const chalk_1 = __importStar(require("../src/lib/chalk"));
const versionUtil = __importStar(require("../src/lib/version-util"));
...
describe('version-util', () => {
    ...
    describe('colorizeDiff', async () => {
        ...
        it('colorize changed patch versions', () => {
            versionUtil.colorizeDiff('1.0.0', '1.0.1').should.equal(`1.0.${chalk_1.default.green('1')}`);
        });
        it('colorize changed minor versions', () => {
            versionUtil.colorizeDiff('1.0.0', '1.1.0').should.equal(`1.${chalk_1.default.cyan('1.0')}`);
        });
        it('colorize changed major versions', () => {
            versionUtil.colorizeDiff('1.0.0', '2.0.0').should.equal(chalk_1.default.red('2.0.0'));
        });
        it('colorize whole parts', () => {
            versionUtil.colorizeDiff('1.0.10', '1.0.11').should.equal(`1.0.${chalk_1.default.green('11')}`);
        });
        ...
        it('colorize changed versions before 1.0.0 as breaking', () => {
            versionUtil.colorizeDiff('0.1.0', '0.2.0').should.equal(`0.${chalk_1.default.red('2.0')}`);
            versionUtil.colorizeDiff('0.1.0', '0.1.1').should.equal(`0.1.${chalk_1.default.red('1')}`);
            versionUtil.colorizeDiff('~0.1.0', '~0.1.1').should.equal(`~0.1.${chalk_1.default.red('1')}`);
        });
    });
...
//# sourceMappingURL=version-util.test.js.map